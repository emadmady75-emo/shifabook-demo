  ...
  useEffect(() => {
    if (doctorProfile) {
      setSelectedFacilityState({
        ...
        mapUrl: doctorProfile.clinicMapUrl || getCleanMapUrl(doctorProfile.hospital || 'Mohandessin Branch - Giza')
      });
    }
  }, [doctorProfile]);
