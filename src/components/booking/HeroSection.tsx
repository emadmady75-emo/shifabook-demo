...
export default function HeroSection() {
  const { language, doctorProfile, isLoadingProfile } = useBooking();
            ...
            <div className="w-full max-w-sm sm:max-w-md glass-panel rounded-[2rem] p-7 relative overflow-hidden shadow-2xl shadow-teal-500/5 border border-teal-500/30 hover:border-teal-500/50 transition-all duration-300 group">
              ...
              {isLoadingProfile ? (
                ...
                <div className="animate-pulse space-y-6">
                  {/* Doctor Avatar & Basic Info Skeleton */}
                  <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-right gap-5">
                    <div className="w-32 h-32 sm:w-36 sm:h-36 rounded-3xl bg-slate-800/60 border-4 border-teal-500/10" />
                    <div className="space-y-3 flex-grow w-full">
                      <div className="h-4 bg-emerald-500/15 border border-emerald-500/10 rounded-md w-28 mx-auto sm:mx-0" />
                      <div className="h-6 bg-slate-800/60 rounded-md w-44 mx-auto sm:mx-0" />
                      <div className="h-4 bg-slate-800/40 rounded-md w-36 mx-auto sm:mx-0" />
                      <div className="h-3.5 bg-slate-800/30 rounded-md w-40 mx-auto sm:mx-0" />
                    </div>
                  </div>

                  {/* Specialization Skeleton */}
                  <div className="pt-5 border-t border-teal-950/60 space-y-2">
                  ...
                  {/* Consultation Fee Skeleton */}
                  <div className="p-4 rounded-2xl bg-[#09151e]/50 border border-teal-900/20 flex items-center justify-between">
                    <div className="space-y-2">
                      <div className="h-3 bg-slate-800/40 rounded w-32" />
                      <div className="h-3 bg-slate-800/30 rounded w-24" />
                    </div>
                    <div className="h-8 bg-teal-500/10 border border-teal-500/20 rounded-lg w-20" />
                  </div>

                  {/* Trust Badges Skeleton */}
                  <div className="flex gap-2 justify-center sm:justify-start">
                    <div className="h-8 bg-slate-800/40 rounded-xl w-28" />
                    <div className="h-8 bg-slate-800/40 rounded-xl w-32" />
                  </div>
                </div>
              ) : (
                <>
